...
def connect(data_source: str, catalog: str = "") -> Session:
    ...
    """
    from pbi_core.dotnet_loader import get_adomd_connection_class, get_server_class
...
def ensure_connected() -> Session:
    ...
    from pbi_core.errors import ConnectionRequiredError
...
def get_session_for_command(ctx: Any) -> Session:
    ...
    from pbi_core.connection_store import get_active_connection, load_connections
