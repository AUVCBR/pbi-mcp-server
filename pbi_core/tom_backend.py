...
def table_create(
    ...
    from pbi_core.dotnet_loader import get_tom_classes
    ...
    if m_expression is not None:
        from pbi_core.dotnet_loader import get_tom_classes as _gtc
...
def export_tmdl(database: Any, folder_path: str) -> dict[str, str]:
    ...
    from pbi_core.dotnet_loader import get_tmdl_serializer
