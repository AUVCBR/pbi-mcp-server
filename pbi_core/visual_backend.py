...
from pbi_core.errors import PbiCliError, VisualTypeError
from pbi_core.pbir_models import (
    SUPPORTED_VISUAL_TYPES,
    VISUAL_TYPE_ALIASES,
)
from pbi_core.pbir_path import get_visual_dir, get_visuals_dir
...
def _load_template(visual_type: str) -> str:
    ...
    template_file = _templates_dir / f"{visual_type}.json"
